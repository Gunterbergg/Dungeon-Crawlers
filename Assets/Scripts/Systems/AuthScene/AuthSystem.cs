...
namespace DungeonCrawlers.Systems
{
	...
	{
		public WebRequest createSessionRequest;
		...
		protected void AuthRequest(FormData formData) {
		...
		private void HandleResponse(string response) {
			try {
				...
				foreach (string linkKey in links.Keys)
					Session.Instance.links[linkKey] = links.GetJSON(linkKey).Deserialize<WebRequest>();
			}
